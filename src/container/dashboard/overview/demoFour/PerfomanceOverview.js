...
const PerformanceOverview = React.memo(() => {
  ...
  const datasets = [
    {
      data: [10, 60, 30],
      backgroundColor: ['#FA8B0C', '#ffa502', '#00E4EC'],
      centerText: '',
  ...
  return (
    <GlobalUtilityStyle className="h-full">
      <Cards
        ...
        size="large"
        className="h-full border-none ant-card-body-p-25 ant-card-head-px-25 ant-card-head-b-none ant-card-body-pt-0 ant-card-body-pb-0 ant-card-head-title-base"
      >
        <>
